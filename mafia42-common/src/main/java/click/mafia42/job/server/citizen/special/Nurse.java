...
import click.mafia42.job.server.mafia.Witch;

public class Nurse extends SkillJob {
    public Nurse(GameRoomUser owner) {
        super(owner, SharedActiveType.NONE, false);
    }

    protected Nurse(Nurse nurse) {
        super(nurse);
    }
